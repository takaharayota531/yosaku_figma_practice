...
class List1803b778b0354ItemWidget extends StatelessWidget {
  List1803b778b0354ItemWidget(this.list1803b778b0354ItemModelObj,
      {this.onTapImgB778B0354});

  List1803b778b0354ItemModel list1803b778b0354ItemModelObj;

  var controller = Get.find<DiscoverController>();

  VoidCallback? onTapImgB778B0354;
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.imgImg64551718x390,
                height: getVerticalSize(
                  207.00,
                ),
                width: getHorizontalSize(
