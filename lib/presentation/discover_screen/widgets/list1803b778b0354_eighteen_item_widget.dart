...
class List1803b778b0354EighteenItemWidget extends StatelessWidget {
  List1803b778b0354EighteenItemWidget(
      this.list1803b778b0354EighteenItemModelObj,
      {this.onTapImgB778B0354Eighteen});

  List1803b778b0354EighteenItemModel list1803b778b0354EighteenItemModelObj;

  var controller = Get.find<DiscoverController>();

  VoidCallback? onTapImgB778B0354Eighteen;
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.img1803b778b035413,
                height: getVerticalSize(
                  207.00,
                ),
                width: getHorizontalSize(
