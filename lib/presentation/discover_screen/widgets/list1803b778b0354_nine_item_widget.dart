...
class List1803b778b0354NineItemWidget extends StatelessWidget {
  List1803b778b0354NineItemWidget(this.list1803b778b0354NineItemModelObj,
      {this.onTapImgB778B0354Nine});

  List1803b778b0354NineItemModel list1803b778b0354NineItemModelObj;

  var controller = Get.find<DiscoverController>();

  VoidCallback? onTapImgB778B0354Nine;
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.img1803b778b03544,
                height: getVerticalSize(
                  207.00,
                ),
                width: getHorizontalSize(
