...
class List1803b778b0354FifteenItemWidget extends StatelessWidget {
  List1803b778b0354FifteenItemWidget(this.list1803b778b0354FifteenItemModelObj,
      {this.onTapImgB778B0354Fifteen});

  List1803b778b0354FifteenItemModel list1803b778b0354FifteenItemModelObj;

  var controller = Get.find<DiscoverController>();

  VoidCallback? onTapImgB778B0354Fifteen;
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.img1803b778b035410,
                height: getVerticalSize(
                  207.00,
                ),
                width: getHorizontalSize(
