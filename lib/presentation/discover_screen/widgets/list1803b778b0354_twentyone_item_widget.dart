...
class List1803b778b0354TwentyoneItemWidget extends StatelessWidget {
  List1803b778b0354TwentyoneItemWidget(
      this.list1803b778b0354TwentyoneItemModelObj,
      {this.onTapImgB778B0354TwentyOne});

  List1803b778b0354TwentyoneItemModel list1803b778b0354TwentyoneItemModelObj;

  var controller = Get.find<DiscoverController>();

  VoidCallback? onTapImgB778B0354TwentyOne;
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.img1803b778b035416,
                height: getVerticalSize(
                  207.00,
                ),
                width: getHorizontalSize(
