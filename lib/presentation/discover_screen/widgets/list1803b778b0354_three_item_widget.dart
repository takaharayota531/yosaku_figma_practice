...
class List1803b778b0354ThreeItemWidget extends StatelessWidget {
  List1803b778b0354ThreeItemWidget(this.list1803b778b0354ThreeItemModelObj,
      {this.onTapImgB778B0354Three});

  List1803b778b0354ThreeItemModel list1803b778b0354ThreeItemModelObj;

  var controller = Get.find<DiscoverController>();

  VoidCallback? onTapImgB778B0354Three;
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              CustomImageView(
                imagePath: ImageConstant.img1803b778b0354,
                height: getVerticalSize(
                  207.00,
                ),
                width: getHorizontalSize(
