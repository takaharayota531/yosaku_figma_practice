        ...
        child: Scaffold(
            body: Container(
                ...
                child: Stack(alignment: Alignment.center, children: [
                  CustomImageView(
                      imagePath: ImageConstant.imgImg64552,
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Align(
                                                                          ...
                                                                          child: Padding(
                                                                              ...
                                                                              child: Text("lbl_22".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtHindSiliguriBold18.copyWith(letterSpacing: 1.08))))
                                                                    ]))),
                                                        Container(
                                                            margin: getMargin(
                                                                top: 6,
